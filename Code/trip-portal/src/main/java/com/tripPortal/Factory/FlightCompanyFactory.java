...
public class FlightCompanyFactory extends PlaneTripFactory {
	// Singleton
    private static FlightCompanyFactory instance;

    private FlightCompanyFactory() {}

    public static FlightCompanyFactory getInstance() {
        if (instance == null) {
            instance = new FlightCompanyFactory();
        }
        return instance;
    }
	...
	public Company createCompany(String name) {
		...
		FlightCompany company = new FlightCompany(name);
